...
4. Execute processos a partir de [`ENGINEERING_SYSTEM_RUNBOOK.md`](./ENGINEERING_SYSTEM_RUNBOOK.md).
5. Use [`../INDICE_DOCUMENTACAO.md`](../INDICE_DOCUMENTACAO.md) para expansão temática.
