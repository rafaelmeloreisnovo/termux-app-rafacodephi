...
public class TermuxFileUtils {
    ...
    public static String getTermuxFilesStatMarkdownString(@NonNull final Context context) {
        ...
        statScript
            ...
            .append(" '/data/data'")
            .append(" '/data/user/0'")
            .append(" '").append(TermuxConstants.TERMUX_INTERNAL_PRIVATE_APP_DATA_DIR_PATH).append("'")
            .append(" '/data/user/0/").append(TermuxConstants.TERMUX_PACKAGE_NAME).append("'")
            .append(" '").append(TermuxConstants.TERMUX_FILES_DIR_PATH).append("'")
            .append(" '").append(filesDir).append("'")
            .append(" '/data/user/0/").append(TermuxConstants.TERMUX_PACKAGE_NAME).append("/files'")
            .append(" '/data/user/").append(TermuxConstants.TERMUX_PACKAGE_NAME).append("/files'")
            .append(" '").append(TermuxConstants.TERMUX_STAGING_PREFIX_DIR_PATH).append("'")
            .append(" '").append(TermuxConstants.TERMUX_PREFIX_DIR_PATH).append("'")
            .append(" '").append(TermuxConstants.TERMUX_HOME_DIR_PATH).append("'")
            .append(" '").append(TermuxConstants.TERMUX_BIN_PREFIX_DIR_PATH).append("/login'")
            .append(" 2>&1")
