...
run_gate compile_numbase \
  "$CC_BIN" -std=c11 -Wall -Wextra -Werror -Os \
  -fno-common -ffunction-sections -fdata-sections \
  -I"$ROOT/rafaelia/src/main/cpp" \
  "$ROOT/rafaelia/src/main/cpp/raf_numbase.c" "$ROOT/tests/native/test_raf_numbase.c" \
  -Wl,--gc-sections -lm -o "$TMP/test_raf_numbase"

run_gate compile_ecc32_compact \
  "$CC_BIN" -std=c11 -Wall -Wextra -Werror -Os -DRAF_ECC32_FORCE_COMPACT=1 \
  -fno-common -ffunction-sections -fdata-sections \
  -I"$ROOT/rafaelia/src/main/cpp" "$ROOT/tests/native/test_raf_ecc32_masked.c" \
  -Wl,--gc-sections -o "$TMP/test_raf_ecc32_compact"

run_gate compile_ecc32_unrolled \
  "$CC_BIN" -std=c11 -Wall -Wextra -Werror -O2 -DRAF_ECC32_FORCE_UNROLL=1 \
  -fno-common -ffunction-sections -fdata-sections \
  -I"$ROOT/rafaelia/src/main/cpp" "$ROOT/tests/native/test_raf_ecc32_masked.c" \
  -Wl,--gc-sections -o "$TMP/test_raf_ecc32_unrolled"

# Host emitters are explicit bounded format fixtures; production syscalls remain ARM-only.
run_gate compile_apkc_dex_emitter \
  "$CC_BIN" -std=c11 -Wall -Wextra -Werror -Os \
  -Wno-error=unused-function -Wno-error=unused-variable \
  -fno-common -ffunction-sections -fdata-sections -I"$ROOT/apkc" \
  "$ROOT/tests/native/apkc_emit_minimal_dex.c" -Wl,--gc-sections \
...
run_gate compile_apkc_one_class_dex_emitter \
  ...
  -Wno-error=unused-function -Wno-error=unused-variable \
  -fno-common -ffunction-sections -fdata-sections -I"$ROOT/apkc" \
  "$ROOT/tests/native/apkc_emit_one_class_dex.c" -Wl,--gc-sections \
...
run_gate compile_apkc_elf_emitter \
  ...
  -Wno-error=unused-function -Wno-error=unused-variable \
  -fno-common -ffunction-sections -fdata-sections -I"$ROOT/apkc" \
  "$ROOT/tests/native/apkc_emit_minimal_elf.c" -Wl,--gc-sections \
...
run_gate compile_apkc_exec_elf_emitter \
  ...
  -Wno-error=unused-function -Wno-error=unused-variable \
  -fno-common -ffunction-sections -fdata-sections -I"$ROOT/apkc" \
  "$ROOT/tests/native/apkc_emit_exec_elf.c" -Wl,--gc-sections \
...
run_gate emit_apkc_elf_rel "$TMP/apkc_emit_minimal_elf" "$TMP/apkc-arm32.o" "$TMP/apkc-arm64.o"
run_gate emit_apkc_elf_exec "$TMP/apkc_emit_exec_elf" "$TMP/apkc-arm32-exec" "$TMP/apkc-arm64-exec"
...
run_gate validate_apkc_dex_capability \
  python3 "$ROOT/scripts/validate_apkc_dex_capability.py"
