...
#
# Default value: `instituto-Rafael`
##
...
# --- RAFCODE-Φ defaults (override via env if needed) ---
# This bundle is intended to be used with the Termux RAFCODEΦ app
# (package: com.termux.rafacodephi). You can override any of these
# via environment variables before running build scripts.
# -------------------------------------------------------------
...
# - https://github.com/termux/termux-packages/wiki/Termux-file-system-layout#termux-private-app-data-directory
#
# Default value: `com.termux.rafacodephi`
##
...
#
# Default value: `/data/data/com.termux.rafacodephi`
##
